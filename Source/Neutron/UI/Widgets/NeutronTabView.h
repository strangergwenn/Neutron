...
class NEUTRON_API SNeutronTabPanel : public SNeutronNavigationPanel
{
	friend class SNeutronTabView;
...
public:
	...
	virtual void OnFocusChanged(TSharedPtr<class SNeutronButton> FocusButton) override;

	/** Set the parent tab view */
	void Initialize(int32 Index, bool IsBlurred, const FSlateBrush* OptionalBackground, class SNeutronTabView* Parent);
...
protected:
	...
	class SNeutronTabView*       ParentTabView;
};

/** Tab view class that takes multiple tab slots, and optional toolbar widgets */
class NEUTRON_API SNeutronTabView : public SCompoundWidget
{
public:
...
public:
	...
	TSharedRef<SNeutronTabPanel> GetCurrentTabContent() const;
...
protected:
	...
	// Tab contents
	TArray<SNeutronTabPanel*> Panels;
