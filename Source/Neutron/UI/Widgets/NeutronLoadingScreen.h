...
class NEUTRON_API SNeutronLoadingScreen : public SCompoundWidget
{
	/*----------------------------------------------------
	    Slate arguments
	----------------------------------------------------*/

	SLATE_BEGIN_ARGS(SNeutronLoadingScreen) : _Settings(nullptr), _Material(nullptr)
	{}

	SLATE_ARGUMENT(TWeakObjectPtr<class UNeutronMenuManager>, MenuManager)
	SLATE_ARGUMENT(const class UNeutronLoadingScreenSetup*, Settings)
...
public:
	...
	SNeutronLoadingScreen() : SCompoundWidget(), AnimatedMaterialInstance(nullptr), LoadingScreenTime(0), CurrentAlpha(0)
	{}
