...
class SNeutronMenuManipulator : public SImage
{
	/*----------------------------------------------------
	    Slate arguments
	----------------------------------------------------*/

	SLATE_BEGIN_ARGS(SNeutronMenuManipulator) : _ColorAndOpacity(FLinearColor::White)
	{}
...
public:
	...
	SNeutronMenuManipulator() : Moving(false)
	{
		SetCanTick(true);
	}
	...
	virtual FReply OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent) override
	{
		...
		{
			UNeutronMenuManager::Get()->MaximizeOrRestore();
