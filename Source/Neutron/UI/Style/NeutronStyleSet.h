...
#include "NeutronMainTheme.h"
#include "NeutronButtonTheme.h"
#include "NeutronSliderTheme.h"
...
class NEUTRON_API FNeutronStyleSet
{
...
public:
	...
	/** Get the main theme */
	static const FNeutronMainTheme& GetMainTheme(const FName& Name = TEXT("DefaultTheme"))
	{
		NCHECK(Name != NAME_None);
		return GetTheme<FNeutronMainTheme>(Name);
	}

	/** Get a button theme */
	static const FNeutronButtonTheme& GetButtonTheme(const FName& Name = TEXT("DefaultButton"))
	{
		NCHECK(Name != NAME_None);
		return GetTheme<FNeutronButtonTheme>(Name);
	}

	/** Get a button size asset */
	static const FNeutronButtonSize& GetButtonSize(const FName& Name = TEXT("DefaultButtonSize"))
	{
		NCHECK(Name != NAME_None);
		return GetTheme<FNeutronButtonSize>(Name);
	}
