...
#include "NeutronSaveManager.generated.h"

/** Base type for save data */
USTRUCT()
struct NEUTRON_API FNeutronSaveDataBase
{
	GENERATED_BODY()
};
...
class NEUTRON_API UNeutronSaveManager : public UObject
{
	GENERATED_BODY()

	friend class FNeutronAsyncSave;
...
public:
	...
	static UNeutronSaveManager* Get()
	{
		return Singleton;
	}
	...
	{
		NLOG("UNeutronSaveManager::SetCurrentSaveData");
	...
	{
		NLOG("UNeutronSaveManager::ReleaseSaveData");
	...
	{
		NLOG("UNeutronSaveManager::SaveGameToFile : synchronous %d", Synchronous);
...
protected:
	...
	// Singleton pointer
	static UNeutronSaveManager* Singleton;
	...
	// Save data
	TSharedPtr<FNeutronSaveDataBase> CurrentSaveData;
